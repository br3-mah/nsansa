            ...
            <div class="col-span-6">
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <div class="panel-heading">
                        ...
                        <button class="btn btn-primary btn-md" @click="startVideoCallToUser(withUser.id)" type="button">
                            <span data-lucide="video"></span> Video Call
                        </button>
                    </div>
                    <div class="intro-y tab-pane active">
